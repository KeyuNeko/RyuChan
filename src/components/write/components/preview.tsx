                    ...
                    <div className="bg-base-100 rounded-2xl shadow-lg w-full overflow-hidden">
                        ...
                        <div className="p-4 md:p-8">
                            ...
                            <div className="mt-8">
                                <article 
                                    id="content"
                                    className="article-prose prose prose-sm md:prose-base prose-code:text-base max-w-none prose-headings:scroll-mt-24 prose-h1:text-2xl md:prose-h1:text-3xl prose-h2:text-xl md:prose-h2:text-2xl prose-h3:text-lg md:prose-h3:text-xl prose-img:rounded-xl prose-img:mx-auto prose-img:cursor-pointer"
                                >
                                    <ReactMarkdown
